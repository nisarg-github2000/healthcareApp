...
class urnologist extends Component {
    render() {
        return (
          <ScrollView>
          {/* Scrollable View */} 
             ...
             <View>
               <Card >
                 <View style={{flexDirection:"row"}} >
                   <View style={{width:88}}>
                     <Image source={require('../../../../../resources/doctorf.jpg')} style={{height:'72%',width:'100%',backgroundColor:"rgba(28, 82, 217, 0.22)"}} />
                   ...
                   <View>
                     <View>
                       <View><Text style={{paddingLeft:20,fontWeight:"bold",fontSize:16}}>Dr. Richa Singh</Text></View>
                       <View><Text style={{paddingLeft:20}}>5 Years of Experience</Text></View>
                     </View>
                       ...
                       <View><Text style={{paddingLeft:20}}>263 Recommends</Text></View>
                   </View>
                 </View>
               </Card>
