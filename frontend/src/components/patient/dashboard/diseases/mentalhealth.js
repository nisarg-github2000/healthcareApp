             ...
             <View>
               <Card >
                 <View style={{flexDirection:"row"}} >
                   ...
                   <View>
                     <View>
                       <View><Text style={{paddingLeft:20,fontWeight:"bold",fontSize:16}}>Dr. Sonu Rana</Text></View>
                       <View><Text style={{paddingLeft:20}}>3 Years of Experience</Text></View>
                     </View>
                       ...
                       <View><Text style={{paddingLeft:20}}>103 Recommends</Text></View>
                   </View>
                 </View>
               </Card>
