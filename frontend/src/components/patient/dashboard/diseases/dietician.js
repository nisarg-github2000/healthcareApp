             ...
             <View>
               <Card >
                 <View style={{flexDirection:"row"}} >
                   ...
                   <View>
                     <View>
                       <View><Text style={{paddingLeft:20,fontWeight:"bold",fontSize:16}}>Dr. Jayant Ohja</Text></View>
                       <View><Text style={{paddingLeft:20}}>10 Years of Experience</Text></View>
                     </View>
                       ...
                       <View><Text style={{paddingLeft:20}}>109 Recommends</Text></View>
                   </View>
                 </View>
               </Card>
