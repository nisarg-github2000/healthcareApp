...
class gastroenterologist extends Component {
    render() {
        return (
          <ScrollView>
          {/* Scrollable View */} 
             ...
             <View>
               <Card >
                 <View style={{flexDirection:"row"}} >
                   ...
                   <View>
                     <View>
                       <View><Text style={{paddingLeft:20,fontWeight:"bold",fontSize:16}}>Dr. Jyantilal Khatwa</Text></View>
                       ...
                       <View><Text style={{paddingLeft:20}}>533 Recommends</Text></View>
                   </View>
                 </View>
               </Card>
