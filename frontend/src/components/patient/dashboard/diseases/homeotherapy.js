             ...
             <View>
               <Card >
                 <View style={{flexDirection:"row"}} >
                   ...
                   <View>
                     <View>
                       <View><Text style={{paddingLeft:20,fontWeight:"bold",fontSize:16}}>Dr. Ramnath Patel</Text></View>
                       <View><Text style={{paddingLeft:20}}>35 Years of Experience</Text></View>
                     </View>
                       ...
                       <View><Text style={{paddingLeft:20}}>1089 Recommends</Text></View>
                   </View>
                 </View>
               </Card>
