...
class patientRegister extends Component {
    ...
    register() {
        ...
        fetch("http://192.168.0.103:3000/api/health/patient/register", {
            method: "POST",
            headers: {
                ...
                <View style={styles.registerPanel}>
                    ...
                    <View style={styles.policyCheckBoxGroup}>
                        <View style={styles.policyCheckBox}>
                            <CheckBox /><Text style={styles.policyCheckBoxText}>By signing up, you agree to Medic's Terms and Condition and Privacy Policy </Text>
                        </View>
                    </View>
