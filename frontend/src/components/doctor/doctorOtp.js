...
class doctorOtpScreen extends Component {
    ...
    verifyOtp(otp) {
        ...
        fetch("http://192.168.0.104:3000/api/health/doctor/verify_otp", {
            method: "POST",
            headers: {
        ...
        .then(data => {
            if(data.error){
                ...
                //this.props.navigation.navigate('DoctorHome', { token: this.state.token });
            }
        })
    }
    ...
    resendOtp(){
        this.showLoader();
        fetch("http://192.168.0.104:3000/api/health/doctor/resend_otp", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
...
export default doctorOtpScreen;
